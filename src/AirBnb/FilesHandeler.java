...
public class FilesHandeler
{
    ...
    private final String HostPath = "F:/Idea/WorkSpace/Airbnb Simplified/src/AirBnb/Host_File.csv" ;
    private final String TraverlerPath = "F:/Idea/WorkSpace/Airbnb Simplified/src/AirBnb/Traveller_file.csv";
    ...
    public void ReadHostData() {
        ...
        try {
            ...
            while (myReader.hasNextLine()) {
                ...
                for (int i=8; i<Row.length ;i=i+8)
                {
